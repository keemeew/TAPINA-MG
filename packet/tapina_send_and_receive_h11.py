...
def send_and_receive():
    ...
    pkts1 = generate_packets(num_packets, 1, "00:00:0a:00:04:0b", "00:01:0a:00:04:0b", "10.0.4.11")  ## need to modify for each host
    pkts2 = generate_packets(num_packets, 2, "00:00:0a:00:04:0b", "00:01:0a:00:04:0b", "10.0.4.11")  ## need to modify for each host
    pkts4 = generate_packets(num_packets, 4, "00:00:0a:00:04:0b", "00:01:0a:00:04:0b", "10.0.4.11")  ## need to modify for each host
...
if __name__ == '__main__':
    ...
    sys.stdout = Logger("/home/tofino/TAPINA/results/h11.txt")
    ...
    iface = "h11-eth0" ## need to modify for each host
