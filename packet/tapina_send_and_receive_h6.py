...
def send_and_receive():
    ...
    pkts2 = generate_packets(num_packets, 2, "00:00:0a:00:02:06", "00:01:0a:00:02:06", "10.0.2.6")  ## need to modify for each host
...
if __name__ == '__main__':
    ...
    sys.stdout = Logger("/home/tofino/TAPINA/results/h6.txt")
    ...
    iface = "h6-eth0" ## need to modify for each host
