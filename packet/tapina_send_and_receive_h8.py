...
def send_and_receive():
    ...
    pkts1 = generate_packets(num_packets, 1, "00:00:0a:00:03:08", "00:01:0a:00:03:08", "10.0.3.8")  ## need to modify for each host
...
if __name__ == '__main__':
    ...
    sys.stdout = Logger("/home/tofino/TAPINA/results/h8.txt")
    ...
    iface = "h8-eth0" ## need to modify for each host
