...
def send_and_receive():
    ...
    pkts3 = generate_packets(num_packets, 3, "00:00:0a:00:03:09", "00:01:0a:00:03:09", "10.0.3.9")  ## need to modify for each host
    pkts4 = generate_packets(num_packets, 4, "00:00:0a:00:03:09", "00:01:0a:00:03:09", "10.0.3.9")  ## need to modify for each host
    pkts5 = generate_packets(num_packets, 5, "00:00:0a:00:03:09", "00:01:0a:00:03:09", "10.0.3.9")  ## need to modify for each host
...
if __name__ == '__main__':
    ...
    sys.stdout = Logger("/home/tofino/TAPINA/results/h9.txt")
    ...
    iface = "h9-eth0" ## need to modify for each host
