...
def send_and_receive():
    ...
    pkts2 = generate_packets(num_packets, 2, "00:00:0a:00:03:07", "00:01:0a:00:03:07", "10.0.3.7")  ## need to modify for each host
    pkts5 = generate_packets(num_packets, 5, "00:00:0a:00:03:07", "00:01:0a:00:03:07", "10.0.3.7")  ## need to modify for each host
...
if __name__ == '__main__':
    ...
    sys.stdout = Logger("/home/tofino/TAPINA/results/h7.txt")
    ...
    iface = "h7-eth0" ## need to modify for each host
