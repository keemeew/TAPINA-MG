...
def send_and_receive():
    ...
    pkts1 = generate_packets(num_packets, 1, "00:00:0a:00:02:05", "00:01:0a:00:02:05", "10.0.2.5")  ## need to modify for each host
    pkts4 = generate_packets(num_packets, 4, "00:00:0a:00:02:05", "00:01:0a:00:02:05", "10.0.2.5")  ## need to modify for each host
...
if __name__ == '__main__':
    ...
    sys.stdout = Logger("/home/tofino/TAPINA/results/h5.txt")
    ...
    iface = "h5-eth0" ## need to modify for each host
